...
// #    include <vsgXchange/all.h>
// #pragma message(STRING(vsgXchange_FOUND))
// #endif
...
int main(int argc, char** argv)
{
    try
    {
        ...
        // std::cout << "vsgXchange def" << std::endl;
#endif
        ...
        // OUR MODELS //////////////////////////////////////////////////////////////////////////////////
        std::vector<std::string> filepaths = {"../models/12219_boat_v2_L2.obj", "../models/skybox.vsgt"};

        // read any files
        for (int i = 0; i < filepaths.size(); ++i)
        {
            // vsg::Path filename = arguments[i];
            vsg::Path filename = filepaths[i];
            path = vsg::filePath(filename);
            vsg::ref_ptr<vsg::Object> object;
            
            if(filename.find(".vsg") != std::string::npos)
            {
            ...
            {
                object = vsg::read_cast<vsg::Node>(filename, options);
